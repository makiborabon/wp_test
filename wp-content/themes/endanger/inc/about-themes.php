...
<div class="description"><?php esc_html_e('Fully compatible with WooCommerce plugin. Just install the plugin and turn your site into a full featured online shop and start selling products.', 'endanger'); ?></div>
	...
	<div class="gt-right">			
			<div>
            <hr />  				
				<a href="<?php echo esc_url(  ENDANGER_LIVE_DEMO); ?>" target="_blank"><?php esc_html_e('Live Demo', 'endanger'); ?></a> | 				
				<a href="<?php echo esc_url(  ENDANGER_THEME_DOC); ?>" target="_blank"><?php esc_html_e('Documentation', 'endanger'); ?></a>
