...
if ( ! class_exists( 'Corporate_Club_Widget_Helper' ) ) {
	 ...
	 * @version 1.0.1
	 */
	class Corporate_Club_Widget_Helper extends WP_Widget {
			...
			switch ( $type ) {
				...
				case 'image':
					...
					<div class="widget-field-image">
						<label for="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>"><?php echo esc_html( $field['label'] ); ?></label>
						<input type="button" class="button button-primary wh-image-picker" value="<?php esc_attr_e( 'Upload', 'corporate-club' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'corporate-club' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'corporate-club' ); ?>" />
						...
						<input type="button" class="button button-secondary btn-image-remove" value="<?php esc_attr_e( 'Remove', 'corporate-club' ); ?>" <?php echo ( empty( $value ) ) ? 'style="display:none;"' : ''; ?> />
