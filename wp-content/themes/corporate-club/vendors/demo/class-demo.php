...
if ( ! class_exists( 'Corporate_Club_Demo' ) ) {
	 ...
	 * @version 1.0.1
	 */
	class Corporate_Club_Demo {

		/**
		 * Singleton instance of Corporate_Club_Demo.
		 *
		 * @var Corporate_Club_Demo $instance Corporate_Club_Demo instance.
		 */
		...
		/**
		 * Main Corporate_Club_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Corporate_Club_Demo ) ) {
				self::$instance = new Corporate_Club_Demo();
