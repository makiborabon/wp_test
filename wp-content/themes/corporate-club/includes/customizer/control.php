 ...
 * @since 1.0.0
 */
class Corporate_Club_Heading_Control extends WP_Customize_Control {
 ...
 * @since 1.0.0
 */
class Corporate_Club_Message_Control extends WP_Customize_Control {
 ...
 */
class Corporate_Club_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'corporate-club' );
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'corporate-club-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Corporate_Club_Dropdown_Sidebars_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Corporate_Club_Radio_Image_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'corporate-club-customize-controls' );
		wp_enqueue_style( 'corporate-club-customize-controls' );
 ...
 * @access public
 */
class Corporate_Club_Upsell_Section extends WP_Customize_Section {
