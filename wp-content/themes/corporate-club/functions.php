...
function corporate_club_scripts() {
	...
	wp_enqueue_style( 'corporate-club-font-awesome', get_template_directory_uri() . '/vendors/font-awesome/css/fontawesome-all' . $min . '.css', '', '5.0.0' );
	...
	wp_enqueue_style( 'corporate-club-style', get_stylesheet_uri(), array(), '2.0.3' );
	...
	wp_enqueue_script( 'corporate-club-custom', get_template_directory_uri() . '/js/custom' . $min . '.js', array( 'jquery' ), '2.0.3', true );
